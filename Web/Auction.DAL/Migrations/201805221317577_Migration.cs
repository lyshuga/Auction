    ...
    public partial class Migration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ApplicationProfiles", t => t.BidderId)
                .ForeignKey("dbo.ApplicationProfiles", t => t.SellerId)
                .Index(t => t.SellerId)
                .Index(t => t.BidderId);
            
            CreateTable(
                "dbo.ApplicationProfiles",
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        Name = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationProfiles", "Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.ApplicationProfiles", new[] { "Id" });
            ...
            DropTable("dbo.ApplicationProfiles");
            DropTable("dbo.Lots");
        }
    }
}
